package com.jsonparser.diff;

import com.jsonparser.core.JsonNull;
import com.jsonparser.core.JsonNumber;
import com.jsonparser.core.JsonObject;
import com.jsonparser.core.JsonString;
...
public class JsonDiffTest {
    ...
    void testDiffAddReplaceRemove() {
        ...
        assertEquals(null, entries.get(1).oldValue);
        assertEquals("Vadodara", entries.get(1).newValue.toString());
    }
}
