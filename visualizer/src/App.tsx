...
import { Box, Code, Search, Download } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    try {
      ...
      // Intentionally not clearing parsedData here so the graph stays visible while typing
    }
  }, [jsonText]);
